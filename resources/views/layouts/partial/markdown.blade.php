...
[^1]: And that\'s the footnote.') !!}</td>
          ...
          <tr>
            <td>\_Markdown tries to translate pared underscores as an emphasis. But..._</td>
            <td>{!! markdown('\_Markdown tries to translate pared underscores as an emphasis. But..._') !!}</td>
          </tr>
        </table>
      </div>
